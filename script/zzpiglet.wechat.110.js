...
let r =
  ((e = 'UnblockURLinWeChat'),
  'undefined' != typeof $notify
    ? JSON.parse($prefs.valueForKey(e) || '{}')
    : JSON.parse($persistentStore.read(e) || '{}'));
var e;
let t = 'true' === r.useCache,
  a = 'true' === r.forceRedirect,
  o = r.wechatExportKey || '';
if ('undefined' != typeof $argument) {
  let r = Object.fromEntries($argument.split('&').map(r => r.split('=')));
  (t = 'true' === r.useCache), (a = 'ture' === r.forceRedirect);
}
const s = $response.body,
  u = 'undefined' != typeof $notify,
  c =
    'undefined' != typeof $environment &&
    $environment['surge-version'] &&
    'iOS' == $environment.system,
  i = 'undefined' != typeof $loon && /iPhone/.test($loon),
  l =
    'undefined' != typeof $environment &&
    $environment['stash-version'] &&
    'iOS' == $environment.system,
  n = 'undefined' != typeof $rocket,
  p = 'undefined' != typeof $native,
  d = u ? 'HTTP/1.1 302 Temporary Redirect' : 302;
let g = JSON.parse(
  /var cgiData = ([\s\S]*);\s*<\/script>/.exec(s)[1].replace(/\\/g, '')
);
var f, m, h, b;
if (
  ((function (r) {
    var e = 'object' == typeof exports && exports,
      t = 'object' == typeof module && module && module.exports == e && module,
    ...
    var o = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
      ...
      D = function (r, e) {
        ...
        return (r >= 55296 && r <= 57343) || r > 1114111
          ? (e &&
            ...
            '�')
          : v(h, r)
          ? (e && x('disallowed character reference'), h[r])
          : (e &&
              (function (r, e) {
      ...
      k = function (r, e) {
        (e = w(e, k.options)).strict && d.test(r) && x('forbidden code point');
        ...
        return (
          t
            ...
            ? (n ||
              ...
              (r = (r = r
                .replace(/&gt;\u20D2/g, '&nvgt;')
                .replace(/&lt;\u20D2/g, '&nvlt;')).replace(c, function (r) {
                return '&' + i[r] + ';';
              })))
            : n || (r = r.replace(l, g)),
          r
            .replace(o, function (r) {
              var e = r.charCodeAt(0),
                t = r.charCodeAt(1);
              return p(1024 * (e - 55296) + t - 56320 + 65536);
            })
            .replace(u, g)
        );
      };
    ...
    var L = function (r, e) {
      var t = (e = w(e, L.options)).strict;
      return (
        t && p.test(r) && x('malformed character reference'),
        r.replace(g, function (r, a, o, s, u, c, i, l, n) {
          var p, d, g, h, b, y;
          return a
            ? f[(b = a)]
            : o
            ? ((b = o),
              (y = s) && e.isAttributeValue
                ? (t &&
                    '=' == y &&
    ...
    L.options = { isAttributeValue: !1, strict: !1 };
    var S = {
      version: '1.2.0',
      encode: k,
      decode: L,
      escape: function (r) {
        return r.replace(l, function (r) {
          return n[r];
        });
      },
      unescape: L
    ...
    if (
      ...
      if (t) t.exports = S;
      else for (var C in S) v(S, C) && (e[C] = S[C]);
    else r.he = S;
  })(this),
  (f =
  ...
  (m = function () {
    var r,
        ...
        'function' == typeof Uint8Array.from
          ...
          : function (r, e) {
              return (
                ...
                new Uint8Array(Array.prototype.slice.call(r, 0).map(e))
              );
            },
      p = function (r) {
      ...
      g = function (r) {
        for (var e, t, a, o, s = '', c = r.length % 3, i = 0; i < r.length; ) {
          if (
            (t = r.charCodeAt(i++)) > 255 ||
            (a = r.charCodeAt(i++)) > 255 ||
            (o = r.charCodeAt(i++)) > 255
          )
            throw new TypeError('invalid character found');
          s +=
            u[((e = (t << 16) | (a << 8) | o) >> 18) & 63] +
            u[(e >> 12) & 63] +
            u[(e >> 6) & 63] +
            u[63 & e];
        }
      ...
      m = a
        ...
        : function (r) {
            for (var e = [], t = 0, a = r.length; t < a; t += 4096)
              e.push(l.apply(null, r.subarray(t, t + 4096)));
            return f(e.join(''));
          },
      h = function (r, e) {
        return void 0 === e && (e = !1), e ? p(m(r)) : m(r);
      },
      b = function (r) {
        if (r.length < 2)
          return (e = r.charCodeAt(0)) < 128
            ? r
            : e < 2048
      ...
      w = function (r, e) {
        return void 0 === e && (e = !1), e ? p(v(r)) : v(r);
      },
      D = function (r) {
        return w(r, !0);
      },
      ...
      k = function (r) {
        ...
        for (var e, t, a, o = '', s = 0; s < r.length; )
          (e =
            (c[r.charAt(s++)] << 18) |
            (c[r.charAt(s++)] << 12) |
            ((t = c[r.charAt(s++)]) << 6) |
      ...
      S = a
        ? function (r) {
            return n(Buffer.from(r, 'base64'));
          }
        : function (r) {
            return n(L(r), function (r) {
      ...
      U = function () {
        var r = function (r, e) {
          return Object.defineProperty(String.prototype, r, N(e));
        };
      ...
      F = function () {
        var r = function (r, e) {
          return Object.defineProperty(Uint8Array.prototype, r, N(e));
        };
        r('toBase64', function (r) {
          return h(this, r);
        }),
      ...
      V = {
        ...
        isValid: function (r) {
          ...
          var e = r.replace(/\s+/g, '').replace(/={0,2}$/, '');
  ...
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(m)
    : ((h = f.Base64),
      ((b = m()).noConflict = function () {
        return (f.Base64 = h), b;
      }),
      f.Meteor && (Base64 = b),
      (f.Base64 = b)),
  'gray' === g.type || 'newgray' === g.type || 'empty' === g.type)
) {
  let r = he.decode(
    `${g.hasOwnProperty('url') ? g.url : /http(.*)/.exec(g.desc)[0]}`
  );
  if (((r = 0 == r.indexOf('http') ? r : 'http://' + r), /qr\.alipay/.test(r)))
    y(
      '',
      '点击跳转到支付宝打开',
      r,
    ...
    if (r.includes('https://spotify.link')) {
      const e = /\$full_url=([^&]+)/;
      r = decodeURIComponent(r).match(e)[1];
    }
    if ((y('', '点击跳转到浏览器打开', r, r), a)) {
      let e = { status: d, headers: { Location: r } };
      u && (e.body = s), $done(e);
    } else $done({});
  }
} else
  'block' === g.type
    ? (async () => {
        let r = g.btns[0].url.replace('newreadtemplate', 'redirecthelpcgi');
        var e;
        /exportkey=(.+)/.test(r) || (o ? (r += o) : $done({})),
          await ((e = r),
          u
            ? ('string' == typeof e && (e = { url: e, method: 'GET' }),
              $task.fetch(e))
            : new Promise((r, t) => {
                $httpClient.get(e, (e, a, o) => {
                  e
                    ? t(e)
                    : r({ statusCode: a.status, headers: a.headers, body: o });
                });
              })).then(r => {
            let e = JSON.parse(r.body);
            if (e.hasOwnProperty('btns')) {
              let r = decodeURIComponent(
                /url=([A-Za-z0-9+/=]+)/.exec(e.btns[0].url)[1]
              );
              if (
                ((r = Base64.decode(r)),
                (r = 0 == r.indexOf('http') ? r : 'http://' + r),
                r.includes('web.archive.org/web'))
              )
                $done({});
              else if ((y('', '点击跳转到浏览器打开', r, r), t)) {
                let e = {
                  status: d,
                  headers: {
                    Location: 'https://web.archive.org/web/20991231999999/' + r
                  }
                };
                u && (e.body = s), $done(e);
              } else $done({});
    ...
    : $done({});
function y(r = '', e = '', t = '', a) {
  if (u && /iOS/.test($environment.version)) {
    let o = {};
    a && (o['open-url'] = a),
      '{}' == JSON.stringify(o) ? $notify(r, e, t) : $notify(r, e, t, o);
  } else if (c || l || p) {
    let o = {};
    a && (o.url = a),
      '{}' == JSON.stringify(o)
        ? $notification.post(r, e, t)
        : $notification.post(r, e, t, o);
  } else if (i) {
    let o = {};
    a && (o.openUrl = a),
      '{}' == JSON.stringify(o)
    ...
    n && (a ? $notification.post(r, e, t, a) : $notification.post(r, e, t));
}
